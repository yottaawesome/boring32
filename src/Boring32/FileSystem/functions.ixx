...
export namespace Boring32::FileSystem
{
	...
	auto GetFileVersion(const std::wstring& filePath) -> std::wstring
	{
		...
		auto size = unsigned{};
		auto lpBuffer = (std::byte*)nullptr; // Free when pBlock argument is freed
		...
		auto verInfo = reinterpret_cast<Win32::VS_FIXEDFILEINFO*>(lpBuffer);
	...
	void CreateFileDirectory(const std::wstring& path, const std::wstring& dacl)
	{
		...
		auto sdDeleter = std::unique_ptr<void, auto(*)(void*)->void>(sd, [](void* ptr) { Win32::LocalFree(ptr); });
	...
	auto FileCreate(
		...
		Win32::DWORD desiredAccess = Win32::GenericRead | Win32::GenericWrite,
		Win32::DWORD shareMode = 0,
		Win32::SECURITY_ATTRIBUTES* const securityAttributes = nullptr,
		Win32::DWORD creationDisposition = Win32::OpenAlways,
		Win32::DWORD flagsAndAttributes = Win32::FileAttributeNormal,
		Win32::HANDLE templateFile = nullptr
	) -> Win32::HANDLE
	{
		if (fileName.empty())
